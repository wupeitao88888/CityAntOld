package com.iloomo.widget.switchview;
...
public class SwitchLayout extends ViewGroup {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                //往左滑动，且是最后一个,这里直接finish掉activity
                    ...
                    System.out.println("-----------");
                    if (onSwitchFinishListener != null)
                        onSwitchFinishListener.onswitchFinish();
    ...
    public void setOnSwitchFinish(OnSwitchFinishListener onSwitchFinishListener) {
