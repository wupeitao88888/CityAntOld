...
public class PCameraHelperBase implements PCameraHelper.CameraHelperImpl {

    private final Context mContext;

    public PCameraHelperBase(final Context context) {
        mContext = context;
    }
    ...
    @Override
    public void getCameraInfo(final int cameraId, final PCameraHelper.CameraInfo2 cameraInfo) {
