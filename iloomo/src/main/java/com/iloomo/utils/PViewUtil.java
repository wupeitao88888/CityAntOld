...
public class PViewUtil {
	...
	public static float dip2px(Context context, float dipValue) {
		DisplayMetrics mDisplayMetrics = com.iloomo.utils.PAppUtil.getDisplayMetrics(context);
	...
	public static float px2dip(Context context, float pxValue) {
		DisplayMetrics mDisplayMetrics =PAppUtil.getDisplayMetrics(context);
	...
	public static void scaleContentView(ViewGroup contentView) {
		PViewUtil.scaleView(contentView);
